...
import { BarChart3, RefreshCw, Filter, ArrowLeft, Inbox, CheckCircle, AlertTriangle, XCircle, Play, Clock } from "lucide-react";
import { Link } from "wouter";
import { fetchApi } from "../../../lib/queryClient";
import { getCoverageBarColor } from "../../../lib/coverageUtils";
import { Card } from "../../../shared/components/ui/Card";
import { Button } from "../../../shared/components/ui/Button";
import { LoadingSpinner } from "../../../shared/components/ui/LoadingSpinner";
import { ThemeCard } from "../components/ThemeCard";
import type { QuestionTopicsResult, PeriodFilter, CoverageFilter } from "../../../types";
      ...
      <Card className="p-6">
        ...
        <div className="flex flex-wrap items-end gap-4">
          ...
          <Button
            ...
            disabled={topicsQuery.isFetching || !selectedProduct}
