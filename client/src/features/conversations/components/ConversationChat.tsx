            ...
            if (item.type === "message") {
              ...
              return (
                <div key={`suggestion-${idx}`} className="flex justify-end">
                  <div className="max-w-[85%] rounded-tl-2xl rounded-tr-sm rounded-br-2xl rounded-bl-2xl shadow-sm px-4 py-2 border-2 bg-gray-200 opacity-60 border-dashed border-gray-300">
