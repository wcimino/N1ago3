...
interface StandardEventsStatsResponse {
  total: number;
...
interface EventTypeMappingsResponse {
...
function AuthorTypeBadge({ type }: { type: string }) {
  const styles: Record<string, string> = {
...
function ZendeskConversationsRawPage() {
  const [page, setPage] = useState(0);
...
function EventTypeMappingsPage() {
