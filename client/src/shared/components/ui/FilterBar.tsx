      ...
      {filters.map((filter, index) => {
          ...
          return (
            <div key={index} className="relative flex-shrink-0">
              ...
              <input
                ...
                className="text-xs border border-gray-300 rounded px-2 pl-7 py-1 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                style={{ width: filter.width || "7rem" }}
              />
            </div>
          );
        }
        ...
        return (
          <select
            ...
            className="text-xs border border-gray-300 rounded px-2 py-1 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 truncate disabled:opacity-50 disabled:cursor-not-allowed"
            style={{ maxWidth: filter.maxWidth || "140px" }}
          >
