...
CREATE INDEX "idx_openai_api_logs_created_at" ON "openai_api_logs" USING btree ("created_at" DESC);
CREATE INDEX "idx_zendesk_webhook_received_at" ON "zendesk_conversations_webhook_raw" USING btree ("received_at" DESC);
CREATE INDEX "idx_conversations_updated_at" ON "conversations" USING btree ("updated_at" DESC);
CREATE INDEX "idx_events_standard_occurred_at" ON "events_standard" USING btree ("occurred_at" DESC);
