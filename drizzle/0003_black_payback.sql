DROP INDEX "idx_conversations_updated_at";--> statement-breakpoint
DROP INDEX "idx_events_standard_occurred_at";--> statement-breakpoint
DROP INDEX "idx_zendesk_webhook_received_at";--> statement-breakpoint
...
CREATE INDEX "idx_zendesk_webhook_received_at" ON "zendesk_conversations_webhook_raw" USING btree ("received_at" DESC NULLS LAST);