-- These indexes already exist with DESC ordering from migration 0005
-- This migration syncs Drizzle snapshots with the actual DB state
-- Using IF EXISTS/IF NOT EXISTS to avoid conflicts with production
...
DROP INDEX IF EXISTS "idx_openai_api_logs_created_at";--> statement-breakpoint
