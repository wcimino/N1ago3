...
CREATE TABLE "openai_api_config" (
	...
	"use_subject_intent_tool" boolean DEFAULT false NOT NULL,
	"use_zendesk_knowledge_base_tool" boolean DEFAULT false NOT NULL,
	"use_objective_problem_tool" boolean DEFAULT false NOT NULL,
	"use_combined_knowledge_search_tool" boolean DEFAULT false NOT NULL,
	"use_knowledge_suggestion_tool" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
